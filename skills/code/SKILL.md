...
1. **Read `docs/PRD.md` Section 9** (Verification Scope). Build a list of all components
   and their tier: Prove or Direct. Read the Target Language field from the PRD header.
...
5. **Summarise.** List what was generated, distinguish Dafny-compiled (Prove-backed) from
   LLM-generated (Direct-backed) functions, and flag any manual review items.
